...
const QMetaObject Food::staticMetaObject = {
    { &FallingObject::staticMetaObject, qt_meta_stringdata_Food.data,
      qt_meta_data_Food,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Food::qt_metacast(const char *_clname)
{
    ...
    return FallingObject::qt_metacast(_clname);
}

int Food::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = FallingObject::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
...
const QMetaObject Ex::staticMetaObject = {
    { &FallingObject::staticMetaObject, qt_meta_stringdata_Ex.data,
      qt_meta_data_Ex,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Ex::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Ex.stringdata0))
        return static_cast<void*>(const_cast< Ex*>(this));
    return FallingObject::qt_metacast(_clname);
}
