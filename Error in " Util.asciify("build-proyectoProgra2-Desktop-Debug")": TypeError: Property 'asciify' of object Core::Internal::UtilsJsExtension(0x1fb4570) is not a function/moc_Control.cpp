...
QT_MOC_LITERAL(3, 17, 8) // "released"

    },
    "Control\0clicked\0\0released"
};
...
void Control::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Control::clicked)) {
                *result = 0;
            }
        }
        {
            typedef void (Control::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Control::released)) {
                *result = 1;
            }
        }
    }
...
void *Control::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsRectItem"))
        return static_cast< QGraphicsRectItem*>(const_cast< Control*>(this));
